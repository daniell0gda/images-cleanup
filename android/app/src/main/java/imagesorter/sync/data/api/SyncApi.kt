...
import imagesorter.sync.data.api.dto.CompleteSessionResponse
import imagesorter.sync.data.api.dto.DeviceStatusResponse
import imagesorter.sync.data.api.dto.ErrorReportItemDto
import imagesorter.sync.data.api.dto.FileOffsetResponse
import imagesorter.sync.data.api.dto.IdentityDto
import imagesorter.sync.data.api.dto.OpenSessionRequest
import imagesorter.sync.data.api.dto.OpenSessionResponse
import imagesorter.sync.data.api.dto.OutcomesResponse
import imagesorter.sync.data.api.dto.ProfileDto
import imagesorter.sync.data.api.dto.ReconcileResponse
import imagesorter.sync.data.api.dto.RegisterDeviceRequest
import imagesorter.sync.data.api.dto.RegisterDeviceResponse
import imagesorter.sync.data.api.dto.VerifyResponse
...
interface SyncApi {
    ...
    suspend fun createProfile(
        @Body body: imagesorter.sync.data.api.dto.ProfileRequest,
    ): ProfileDto
