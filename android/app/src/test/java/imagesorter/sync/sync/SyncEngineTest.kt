...
import imagesorter.sync.support.FakeMediaSource
import imagesorter.sync.support.FakeSyncPrefs
...
class SyncEngineTest {
    ...
    fun startOfRunPostsAllUnreportedFailuresInOneRequestAndMarksThemReported() = runTest {
        db.failureDao().upsert(
            imagesorter.sync.data.db.entity.FailureEntity(
    ...
    private class GatedProfilePrefs : SyncPrefs {
        ...
        override fun getMediaGeneration(): Long = imagesorter.sync.data.prefs.SecurePrefs.NO_WATERMARK
